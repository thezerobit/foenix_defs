#ifndef VKYII_CFP9553_GENERAL_DEF_H
#define VKYII_CFP9553_GENERAL_DEF_H
...
#define SYNC_Turn_Off    0x04    /* 0 = Normal Operation, 1 = Turn Off Sync to get sleep mode from Monitor */
